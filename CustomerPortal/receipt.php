...
<div>
    ...
    <form name="finish" method="post" action="login.html">
        ...
        <label>Reservation Status : Paid</label>
        <br><br>
        ...
        echo "<label>" . 'Amount paid : ' . $payment_amount . "</label><br> <br>";
        ...
        mysqli_query($db, "UPDATE payment SET payment_status = 'PAID' where payment_id = '$payment_id'");

        $payment_method = $_POST['payment'];

        mysqli_query($db, "UPDATE payment SET payment_method = '$payment_method' where payment_id = '$payment_id'");
